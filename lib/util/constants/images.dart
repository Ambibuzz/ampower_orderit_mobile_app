class Images {
  // gif
  static const emptyCartGif = 'assets/gif/empty_cart.gif';

  // icon
  static const backButtonIcon = 'assets/icon/back_button_icon.png';
  static const catalogViewIcon = 'assets/icon/catalogue_view_icon.png';
  static const categoryIcon = 'assets/icon/category_icon.png';
